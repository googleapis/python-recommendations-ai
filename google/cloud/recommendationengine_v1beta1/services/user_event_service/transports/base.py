...
class UserEventServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self):
        ...
        self._wrapped_methods = {
            self.write_user_event: gapic_v1.method.wrap_method(
                self.write_user_event, default_timeout=None, client_info=_client_info,
            ),
            self.collect_user_event: gapic_v1.method.wrap_method(
                self.collect_user_event, default_timeout=None, client_info=_client_info,
            ),
            self.list_user_events: gapic_v1.method.wrap_method(
                self.list_user_events, default_timeout=None, client_info=_client_info,
            ),
            self.purge_user_events: gapic_v1.method.wrap_method(
                self.purge_user_events, default_timeout=None, client_info=_client_info,
            ),
            self.import_user_events: gapic_v1.method.wrap_method(
                self.import_user_events, default_timeout=None, client_info=_client_info,
            ),
        }
    ...
    def write_user_event(
        ...
        typing.Union[user_event.UserEvent, typing.Awaitable[user_event.UserEvent]],
    ]:
        raise NotImplementedError()
