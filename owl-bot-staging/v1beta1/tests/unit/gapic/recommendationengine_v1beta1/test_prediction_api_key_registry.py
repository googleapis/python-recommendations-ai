...
def test_prediction_api_key_registry_client_from_service_account_info(client_class, transport_name):
...
def test_prediction_api_key_registry_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (PredictionApiKeyRegistryClient, transports.PredictionApiKeyRegistryRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (PredictionApiKeyRegistryClient, transports.PredictionApiKeyRegistryRestTransport, "rest", "true"),
    (PredictionApiKeyRegistryClient, transports.PredictionApiKeyRegistryRestTransport, "rest", "false"),
])
@mock.patch.object(PredictionApiKeyRegistryClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PredictionApiKeyRegistryClient))
@mock.patch.object(PredictionApiKeyRegistryAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PredictionApiKeyRegistryAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (PredictionApiKeyRegistryClient, transports.PredictionApiKeyRegistryRestTransport, "rest", None),
])
...
async def test_list_prediction_api_key_registrations_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_prediction_api_key_registrations(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_prediction_api_key_registration_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration.pb(return_value)
...
def test_create_prediction_api_key_registration_rest_required_fields(request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_prediction_api_key_registration._get_unset_required_fields(jsonified_request)
...
def test_create_prediction_api_key_registration_rest_unset_required_fields():
    transport = transports.PredictionApiKeyRegistryRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_prediction_api_key_registration._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "predictionApiKeyRegistration", )))
...
def test_create_prediction_api_key_registration_rest_interceptors(null_interceptor):
    transport = transports.PredictionApiKeyRegistryRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.PredictionApiKeyRegistryRestInterceptor(),
        )
    client = PredictionApiKeyRegistryClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "post_create_prediction_api_key_registration") as post, \
         mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "pre_create_prediction_api_key_registration") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest.pb(prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest())
        ...
        req.return_value._content = prediction_apikey_registry_service.PredictionApiKeyRegistration.to_json(prediction_apikey_registry_service.PredictionApiKeyRegistration())
        ...
        post.return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration()

        client.create_prediction_api_key_registration(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_prediction_api_key_registration_rest_bad_request(transport: str = 'rest', request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_prediction_api_key_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/predictionApiKeyRegistrations" % client.transport._host, args[1])


def test_create_prediction_api_key_registration_rest_flattened_error(transport: str = 'rest'):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_prediction_api_key_registrations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_prediction_api_key_registrations_rest_required_fields(request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest):
    transport_class = transports.PredictionApiKeyRegistryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_prediction_api_key_registrations._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_prediction_api_key_registrations_rest_unset_required_fields():
    ...
    unset_fields = transport.list_prediction_api_key_registrations._get_unset_required_fields({})
...
def test_list_prediction_api_key_registrations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "post_list_prediction_api_key_registrations") as post, \
         mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "pre_list_prediction_api_key_registrations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest.pb(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse.to_json(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse())
        ...
        client.list_prediction_api_key_registrations(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_prediction_api_key_registrations_rest_bad_request(transport: str = 'rest', request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_prediction_api_key_registrations_rest_flattened_error(transport: str = 'rest'):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_prediction_api_key_registrations_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse.to_json(x) for x in response)
        ...
        pages = list(client.list_prediction_api_key_registrations(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_delete_prediction_api_key_registration_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/catalogs/sample3/eventStores/sample4/predictionApiKeyRegistrations/sample5'}
    request = request_type(**request_init)
...
def test_delete_prediction_api_key_registration_rest_required_fields(request_type=prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest):
    transport_class = transports.PredictionApiKeyRegistryRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_prediction_api_key_registration._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_prediction_api_key_registration_rest_unset_required_fields():
    ...
    unset_fields = transport.delete_prediction_api_key_registration._get_unset_required_fields({})
...
def test_delete_prediction_api_key_registration_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, "pre_delete_prediction_api_key_registration") as pre:
        pre.assert_not_called()
        pb_message = prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest.pb(prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_prediction_api_key_registration(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_prediction_api_key_registration_rest_bad_request(transport: str = 'rest', request_type=prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_prediction_api_key_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/catalogs/sample3/eventStores/sample4/predictionApiKeyRegistrations/sample5'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{name=projects/*/locations/*/catalogs/*/eventStores/*/predictionApiKeyRegistrations/*}" % client.transport._host, args[1])


def test_delete_prediction_api_key_registration_rest_flattened_error(transport: str = 'rest'):
    client = PredictionApiKeyRegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
