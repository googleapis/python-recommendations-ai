...
from google.cloud.recommendationengine_v1beta1.services.user_event_service.transports.base import _API_CORE_VERSION
from google.cloud.recommendationengine_v1beta1.services.user_event_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_user_event_service_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_write_user_event(transport: str = 'grpc', request_type=user_event_service.WriteUserEventRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_collect_user_event(transport: str = 'grpc', request_type=user_event_service.CollectUserEventRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_user_events(transport: str = 'grpc', request_type=user_event_service.ListUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_user_events(transport: str = 'grpc', request_type=user_event_service.PurgeUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_user_events(transport: str = 'grpc', request_type=import_.ImportUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_user_event_service_transport_create_channel_old_api_core(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
...
@requires_api_core_lt_1_26_0
def test_user_event_service_transport_create_channel_user_scopes(transport_class, grpc_helpers):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc, mock.patch.object(
        grpc_helpers, "create_channel", autospec=True
