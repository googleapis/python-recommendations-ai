...
from google.cloud.recommendationengine_v1beta1.services.user_event_service import UserEventServiceAsyncClient
...
from google.cloud.recommendationengine_v1beta1.services.user_event_service import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (UserEventServiceAsyncClient, transports.UserEventServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (UserEventServiceClient, transports.UserEventServiceGrpcTransport, "grpc", "true"),
    (UserEventServiceAsyncClient, transports.UserEventServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (UserEventServiceClient, transports.UserEventServiceGrpcTransport, "grpc", "false"),
    (UserEventServiceAsyncClient, transports.UserEventServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (UserEventServiceClient, transports.UserEventServiceRestTransport, "rest", "true"),
    (UserEventServiceClient, transports.UserEventServiceRestTransport, "rest", "false"),
])
@mock.patch.object(UserEventServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UserEventServiceClient))
@mock.patch.object(UserEventServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UserEventServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    UserEventServiceClient, UserEventServiceAsyncClient
])
@mock.patch.object(UserEventServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UserEventServiceClient))
@mock.patch.object(UserEventServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(UserEventServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (UserEventServiceClient, transports.UserEventServiceGrpcTransport, "grpc", grpc_helpers),
    (UserEventServiceAsyncClient, transports.UserEventServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (UserEventServiceClient, transports.UserEventServiceRestTransport, "rest", None),
])
...
def test_user_event_service_client_client_options_from_dict():
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.user_event_service.transports.UserEventServiceGrpcTransport.__init__') as grpc_transport:
...
def test_write_user_event(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.write_user_event),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_write_user_event_async(transport: str = 'grpc_asyncio', request_type=user_event_service.WriteUserEventRequest):
...
def test_collect_user_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.collect_user_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_collect_user_event_async(transport: str = 'grpc_asyncio', request_type=user_event_service.CollectUserEventRequest):
    client = UserEventServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_user_events(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_user_events),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_user_events_async(transport: str = 'grpc_asyncio', request_type=user_event_service.ListUserEventsRequest):
    client = UserEventServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_user_events_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, user_event.UserEvent)
                   for i in results)
...
async def test_list_user_events_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_user_events(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_purge_user_events(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.purge_user_events),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_purge_user_events_async(transport: str = 'grpc_asyncio', request_type=user_event_service.PurgeUserEventsRequest):
    client = UserEventServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_user_events(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.import_user_events),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_import_user_events_async(transport: str = 'grpc_asyncio', request_type=import_.ImportUserEventsRequest):
    client = UserEventServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_write_user_event_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = gcr_user_event.UserEvent.pb(return_value)
...
def test_write_user_event_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "userEvent", )))
...
def test_write_user_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.UserEventServiceRestInterceptor, "post_write_user_event") as post, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "pre_write_user_event") as pre:
        ...
        req.return_value._content = gcr_user_event.UserEvent.to_json(gcr_user_event.UserEvent())
        ...
        post.return_value = gcr_user_event.UserEvent()
...
def test_write_user_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        sample_request = {'parent': 'projects/sample1/locations/sample2/catalogs/sample3/eventStores/sample4'}
        ...
        client.write_user_event(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/userEvents:write" % client.transport._host, args[1])
...
def test_collect_user_event_rest_required_fields(request_type=user_event_service.CollectUserEventRequest):
    ...
    assert not set(unset_fields) - set(("ets", "uri", "user_event", ))
    jsonified_request.update(unset_fields)
...
def test_collect_user_event_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("ets", "uri", "userEvent", )) & set(("parent", "userEvent", )))
...
def test_collect_user_event_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "post_collect_user_event") as post, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "pre_collect_user_event") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_collect_user_event_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.collect_user_event(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/userEvents:collect" % client.transport._host, args[1])
...
def test_list_user_events_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        # Designate an appropriate value for the returned response.
        return_value = user_event_service.ListUserEventsResponse(
              next_page_token='next_page_token_value',
        )
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = user_event_service.ListUserEventsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_user_events_rest_required_fields(request_type=user_event_service.ListUserEventsRequest):
    transport_class = transports.UserEventServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_user_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "post_list_user_events") as post, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "pre_list_user_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = user_event_service.ListUserEventsRequest.pb(user_event_service.ListUserEventsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = user_event_service.ListUserEventsResponse.to_json(user_event_service.ListUserEventsResponse())
        ...
        pre.return_value = request, metadata
        post.return_value = user_event_service.ListUserEventsResponse()

        client.list_user_events(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_user_events_rest_bad_request(transport: str = 'rest', request_type=user_event_service.ListUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_user_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.list_user_events(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/userEvents" % client.transport._host, args[1])
...
def test_list_user_events_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        response = tuple(user_event_service.ListUserEventsResponse.to_json(x) for x in response)
        ...
        pager = client.list_user_events(request=sample_request)
        ...
        pages = list(client.list_user_events(request=sample_request).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_purge_user_events_rest_required_fields(request_type=user_event_service.PurgeUserEventsRequest):
    transport_class = transports.UserEventServiceRestTransport
...
def test_purge_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.UserEventServiceRestInterceptor, "post_purge_user_events") as post, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "pre_purge_user_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = user_event_service.PurgeUserEventsRequest.pb(user_event_service.PurgeUserEventsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_purge_user_events_rest_bad_request(transport: str = 'rest', request_type=user_event_service.PurgeUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_purge_user_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.purge_user_events(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/userEvents:purge" % client.transport._host, args[1])
...
def test_import_user_events_rest_required_fields(request_type=import_.ImportUserEventsRequest):
    transport_class = transports.UserEventServiceRestTransport
...
def test_import_user_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "post_import_user_events") as post, \
         mock.patch.object(transports.UserEventServiceRestInterceptor, "pre_import_user_events") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = import_.ImportUserEventsRequest.pb(import_.ImportUserEventsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_import_user_events_rest_bad_request(transport: str = 'rest', request_type=import_.ImportUserEventsRequest):
    client = UserEventServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_user_events_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        client.import_user_events(**mock_args)

        # Establish that the underlying call was made with the expected
        # request object values.
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1beta1/{parent=projects/*/locations/*/catalogs/*/eventStores/*}/userEvents:import" % client.transport._host, args[1])
...
def test_user_event_service_base_transport():
    ...
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.user_event_service.transports.UserEventServiceTransport.__init__') as Transport:
...
def test_user_event_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.recommendationengine_v1beta1.services.user_event_service.transports.UserEventServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_user_event_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.recommendationengine_v1beta1.services.user_event_service.transports.UserEventServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.UserEventServiceTransport()
        adc.assert_called_once()
...
def test_user_event_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
def test_user_event_service_client_transport_session_collision(transport_name):
    ...
    assert session1 != session2
    session1 = client1.transport.list_user_events._session
    session2 = client2.transport.list_user_events._session
    assert session1 != session2
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.UserEventServiceGrpcTransport, transports.UserEventServiceGrpcAsyncIOTransport])
def test_user_event_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_event_store_path():
    ...
    actual = UserEventServiceClient.event_store_path(project, location, catalog, event_store)
