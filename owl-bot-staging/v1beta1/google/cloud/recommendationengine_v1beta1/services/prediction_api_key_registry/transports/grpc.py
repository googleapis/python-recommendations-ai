...
class PredictionApiKeyRegistryGrpcTransport(PredictionApiKeyRegistryTransport):
    ...
    def create_prediction_api_key_registration(self) -> Callable[
        ...
        if 'create_prediction_api_key_registration' not in self._stubs:
            self._stubs['create_prediction_api_key_registration'] = self.grpc_channel.unary_unary(
    ...
    def list_prediction_api_key_registrations(self) -> Callable[
        ...
        if 'list_prediction_api_key_registrations' not in self._stubs:
            self._stubs['list_prediction_api_key_registrations'] = self.grpc_channel.unary_unary(
    ...
    def delete_prediction_api_key_registration(self) -> Callable[
        ...
        if 'delete_prediction_api_key_registration' not in self._stubs:
            self._stubs['delete_prediction_api_key_registration'] = self.grpc_channel.unary_unary(
