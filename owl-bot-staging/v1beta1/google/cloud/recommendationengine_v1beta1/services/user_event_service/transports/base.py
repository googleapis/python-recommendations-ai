...
class UserEventServiceTransport(abc.ABC):
    ...
    @property
    def write_user_event(self) -> typing.Callable[
    ...
    @property
    def collect_user_event(self) -> typing.Callable[
            [user_event_service.CollectUserEventRequest],
            typing.Union[
                httpbody.HttpBody,
                typing.Awaitable[httpbody.HttpBody]
            ]]:
        raise NotImplementedError()

    @property
    def list_user_events(self) -> typing.Callable[
    ...
    @property
    def purge_user_events(self) -> typing.Callable[
    ...
    @property
    def import_user_events(self) -> typing.Callable[
