...
class CatalogServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_catalog_item(self, request: catalog_service.CreateCatalogItemRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[catalog_service.CreateCatalogItemRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_catalog_item(self, response: catalog.CatalogItem) -> catalog.CatalogItem:
        ...
        """
        return response
    def pre_delete_catalog_item(self, request: catalog_service.DeleteCatalogItemRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[catalog_service.DeleteCatalogItemRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_catalog_item(self, request: catalog_service.GetCatalogItemRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[catalog_service.GetCatalogItemRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_catalog_item(self, response: catalog.CatalogItem) -> catalog.CatalogItem:
        ...
        """
        return response
    def pre_import_catalog_items(self, request: import_.ImportCatalogItemsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[import_.ImportCatalogItemsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_import_catalog_items(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_list_catalog_items(self, request: catalog_service.ListCatalogItemsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[catalog_service.ListCatalogItemsRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_catalog_items(self, response: catalog_service.ListCatalogItemsResponse) -> catalog_service.ListCatalogItemsResponse:
        ...
        """
        return response
    def pre_update_catalog_item(self, request: catalog_service.UpdateCatalogItemRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[catalog_service.UpdateCatalogItemRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_catalog_item(self, response: catalog.CatalogItem) -> catalog.CatalogItem:
...
class CatalogServiceRestTransport(CatalogServiceTransport):
    ...
    class _CreateCatalogItem(CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{parent=projects/*/locations/*/catalogs/*}/catalogItems',
                'body': 'catalog_item',
            },
            ]
            request, metadata = self._interceptor.pre_create_catalog_item(request, metadata)
            pb_request = catalog_service.CreateCatalogItemRequest.pb(request)
    ...
    class _DeleteCatalogItem(CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v1beta1/{name=projects/*/locations/*/catalogs/*/catalogItems/**}',
            },
            ]
            request, metadata = self._interceptor.pre_delete_catalog_item(request, metadata)
            pb_request = catalog_service.DeleteCatalogItemRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetCatalogItem(CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_get_catalog_item(request, metadata)
            pb_request = catalog_service.GetCatalogItemRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ImportCatalogItems(CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta1/{parent=projects/*/locations/*/catalogs/*}/catalogItems:import',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_import_catalog_items(request, metadata)
            pb_request = import_.ImportCatalogItemsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListCatalogItems(CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_list_catalog_items(request, metadata)
            pb_request = catalog_service.ListCatalogItemsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateCatalogItem(CatalogServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            request, metadata = self._interceptor.pre_update_catalog_item(request, metadata)
            pb_request = catalog_service.UpdateCatalogItemRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
