...
class CatalogServiceTransport(abc.ABC):
    ...
    @property
    def create_catalog_item(self) -> typing.Callable[
            [catalog_service.CreateCatalogItemRequest],
            typing.Union[
                catalog.CatalogItem,
                typing.Awaitable[catalog.CatalogItem]
            ]]:
        raise NotImplementedError()

    @property
    def get_catalog_item(self) -> typing.Callable[
    ...
    @property
    def list_catalog_items(self) -> typing.Callable[
    ...
    @property
    def update_catalog_item(self) -> typing.Callable[
    ...
    @property
    def delete_catalog_item(self) -> typing.Callable[
    ...
    @property
    def import_catalog_items(self) -> typing.Callable[
